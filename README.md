DTO는 몸 건강이슈로 시간이 부족할거같아서 진행 못했습니다.
현재 강사님 말씀처럼 스프링 부트 구조가 익숙해지는게 목표입니다. 이쪽 관련해서 피드백 많이 주시면 감사합니다
+ 아마 피드백 할게 많을거같아서 죄송하고 ㅎㅎ 감사합니다 :)

# 0. 실습 환경 및 제출 방법

## 실습 환경

Build tool (Maven): 메이븐은 자료가 많아 초보자가 문제 해결하기 쉽고, 표준화된 프로젝트 구조를 제공해 선택했습니다.

Language (Java 21): 자바 21은 안정적인 최신 LTS 버전 이여서 사용했습니다.
