...
public class InMemoryMeetingRoomRepository implements MeetingRoomRepository {
    ...
    private List<MeetingRoom> initMeetingRooms() {
        return List.of(
                MeetingRoom.create("회의실 101", MeetingRoomLocation.create(1, 1)).withAssignedId(1L),
                MeetingRoom.create("회의실 102", MeetingRoomLocation.create(1, 2)).withAssignedId(2L),
                MeetingRoom.create("회의실 103", MeetingRoomLocation.create(1, 3)).withAssignedId(3L),
                MeetingRoom.create("회의실 201", MeetingRoomLocation.create(2, 1)).withAssignedId(4L),
                MeetingRoom.create("회의실 202", MeetingRoomLocation.create(2, 2)).withAssignedId(5L),
                MeetingRoom.create("회의실 301", MeetingRoomLocation.create(3, 1)).withAssignedId(6L),
                MeetingRoom.create("지하 1층 1번 회의실", MeetingRoomLocation.create(-1, 1)).withAssignedId(7L)
        );
    }
